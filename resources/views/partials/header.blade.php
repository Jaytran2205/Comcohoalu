<header id="site-header" class="fixed top-0 left-0 right-0 z-40 transition-all duration-500 {{ request()->routeIs('home') ? 'header-transparent' : 'header-scrolled' }}">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <nav class="hidden xl:flex items-center space-x-1.5 2xl:space-x-2.5">
            ...
            <a href="{{ route('posts.category', 'khuyen-mai') }}" class="nav-link nav-link-item px-2.5 py-1 rounded-md transition-all duration-200 text-[13px] xl:text-[14px] 2xl:text-[15px] whitespace-nowrap {{ $isPromo ? 'active font-bold' : 'font-semibold' }}">Khuyến mãi</a>
            
            <a href="{{ route('posts.category', 'tuyen-dung') }}" class="nav-link nav-link-item px-2.5 py-1 rounded-md transition-all duration-200 text-[13px] xl:text-[14px] 2xl:text-[15px] whitespace-nowrap {{ $isRecruit ? 'active font-bold' : 'font-semibold' }}">Tuyển dụng</a>
            
            <a href="{{ route('contact') }}" class="nav-link nav-link-item px-2.5 py-1 rounded-md transition-all duration-200 text-[13px] xl:text-[14px] 2xl:text-[15px] whitespace-nowrap {{ $isContact ? 'active font-bold' : 'font-semibold' }}">Liên hệ</a>
        </nav>
